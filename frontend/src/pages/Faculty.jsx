...
const TEACHERS = [
  {
    name: "DR.Shatrughan ",
    role: "Teaching Marketing",
    image: "images/Amar.jpg",
    bio: "MBA in Marketing from MIT. Pioneered adaptive learning algorithms adopted by 3 Fortune 500 companies.",
    tag: "MBA, PhD",
    courses: 24,
    students: 4800,
    rating: 4.9,
